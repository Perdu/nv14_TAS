...
I digged into the code to check whether this can be done with inputs, but it's not the case. [Relevant part of the code](../external/n_v14_codedump.as:11706):
```
...
We've been wondering for a while if holding left and right in a frame is strictly the same as doing nothing. [It is](../external/n_v14_codedump.as:12176):
