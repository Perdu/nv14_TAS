function ProjAABB_22DegS(x, y, obj, t)
{
   var _loc13_ = t.signx;
   var _loc8_ = t.signy;
   var _loc14_ = obj.pos.y - _loc8_ * obj.yw;
   var _loc3_ = t.pos.y - _loc14_;
   var _loc16_;
   var _loc15_;
   var _loc5_;
   var _loc4_;
   ...
   if(0 < _loc3_ * _loc8_)
   {
      _loc16_ = obj.pos.x - _loc13_ * obj.xw - (t.pos.x + _loc13_ * t.xw);
      _loc15_ = obj.pos.y - _loc8_ * obj.yw - (t.pos.y - _loc8_ * t.yw);
      _loc5_ = t.sx;
      _loc4_ = t.sy;
      ...
      if(_loc9_ < 0)
      {
         ...
         if(_loc7_ < _loc10_)
         {
            if(_loc6_ < _loc7_)
            {
               obj.ReportCollisionVsWorld(0,_loc3_,0,_loc3_ / _loc6_,t);
               return COL_OTHER;
            }
