...
# n-related commands
  ...
  RUN echo "/root/src/ruffle/target/release/ruffle_desktop -g gl /home/n_v14.swf\n/root/src/libTAS/build/AppDir/usr/bin/libTAS -i -n -L -r /home/n_levels/\${LEVEL}_rta.ltm --lua /home/lua/n_dump_ghost.lua /root/src/ruffle/target/release/ruffle_desktop -g gl --no-gui --width 800 /home/n_v14.swf &\nLEVEL='00-0' ; /root/src/libTAS/build/AppDir/usr/bin/libTAS -i -r /home/n_levels/\$LEVEL.ltm --lua /home/lua/n_start.lua /root/src/ruffle/target/release/ruffle_desktop -g gl --no-gui --width 792 /home/n_v14.swf &" > /root/.bash_history
