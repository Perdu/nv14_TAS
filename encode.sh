...
docker run --rm -it -e DISPLAY=$DISPLAY -v /tmp/.X11-unix:/tmp/.X11-unix -v $HOME/.Xauthority:/root/.Xauthority:rw --net=host -v $SCRIPT_DIR/volume:/home/ -v $SCRIPT_DIR/patch_config_recording.txt:/home/patch_config.txt:ro $IMAGE bash -c "$HEADLESS libTAS -n -r /home/n_levels/$LEVEL.ltm --lua /home/lua/n_ghost.lua,/home/lua/display_infos.lua -d /home/n_demos/$LEVEL.mp4 /usr/local/bin/ruffle_desktop -g gl --no-gui --width 792 /home/n_v14_patched.swf ; while ffprobe /home/n_demos/$LEVEL.mp4 2>&1 | grep -q 'moov atom not found'; do sleep 1 ; done "
